...
public class Puzzle {
    ...
    public String solveGenetic(geneticSolver solver, int maxIteration) throws InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        //geneticSolver solver = new geneticSolver(this, 2, 0, 1, 0);
        solver.initPopulation();
        long startTime = System.nanoTime();
        Chromosome solution = solver.solve(maxIteration);
        long endTime = System.nanoTime();
        long duration = (long) ((endTime - startTime) / 1000000); //divide by 1000000 to get milliseconds.
        if(solution == null){
